  ...
  render() {
    ...
    return (
      ...
      <Grid container xs={12}>
        <Grid item xs={8}>
          <Typography variant='h5'>Gangguan Ulang</Typography>
          <Typography variant='body2' color='textSecondary'>Regional Operation Center VII</Typography>
          {/* blank */}
        </Grid>
        <Grid item xs={4}>
      ...
      <Grid container xs={12}>
        <Table className={classes.table}>
          {/*   // Order: STO | Target | Real | Ach. | Growth  */}
          <TableHead>
            <TableRow>
              <THead>No.</THead>
              <THead>TPT</THead>
...
export default withStyles(styles)(Gaul);